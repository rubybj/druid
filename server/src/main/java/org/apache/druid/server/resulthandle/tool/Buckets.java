...
public class Buckets {
    ...
    public static void main(String[] str){
        String s="50%以下,50%-60%,60%-70%,70%-80%,80%-90%,90%-95%,95%-96%,96%-97%,97%-98%,98%-99%,99%-100%,100%以上";
        try{
        ...
        //int buckets[]=createBuckets("0,29,33,45,52,80,90,95,97,100,2147438647");
        //int buckets2[]=createBuckets("0,5000,6000,7000,8000,9000,10000,2147438647");
        //putDataToBuckets(buckets,45.23232);
    }
}
